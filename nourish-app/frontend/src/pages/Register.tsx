    ...
    <div className="min-h-screen bg-gradient-to-br from-nourish-400 via-nourish-500 to-nourish-600 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="bg-nourish-beige-50 rounded-2xl shadow-2xl p-8 md:p-12 w-full max-w-md mx-4 z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Name Field */}
          <div>
            <label htmlFor="name" className="block text-sm font-medium text-nourish-gray-700 mb-2">
              Full Name
            </label>
            <input
              id="name"
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-nourish-gray-700 mb-2">
              Confirm Password
            </label>
            <div className="relative">
              <input
          ...
          <div className="text-center text-sm">
            <span className="text-nourish-gray-600">Already have an account? </span>
            <Link to="/login" className="text-nourish-500 hover:text-nourish-600 font-medium transition">
              Sign in
            </Link>
          </div>
        </form>
